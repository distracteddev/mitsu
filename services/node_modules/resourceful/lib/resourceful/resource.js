    ...
    args.push(function (e, result) {
      ...
      if (e) {
        ...
        if (Array.isArray(result)) {
          // Check to see if the array contains Resource objects                   
          if (result[0] && typeof result[0].resource === "undefined") {
            // Since this view does not return a resource, do nothing to the result
          } else {
            // If the view returns a resource, then try to instantiate it
